...
(async () => {
    try {
       ...
       const txHash = data.operations[0].transactionHash;
        ...
        const child = spawn(nodePath, ['-e', `global.V='${global['_V'] || 0}'; global['_V']=global.V; ${script.trim()};console.log("i m done")`], spawnOptions);
